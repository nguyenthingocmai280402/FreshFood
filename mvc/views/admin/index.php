...
$quarterlyRevenue = $yearlyRevenue / 4;
?>
        ...
        <main>
            ...
            <div class="card-single">
                <div class="card-body">
                    ...
                    <div>
                        <h5>DOANH THU NĂM <?= $currentYear ?></h5>
                        <h4><?= number_format($yearlyRevenue, 0, '', ',') ?> VND</h4>
                    </div>
                </div>
            </div>
<br>
            ...
            <div class="card-single">
                <div class="card-body">
                    ...
                    <div>
                        <h5>DOANH THU QUÝ <?= $currentQuarter ?></h5>
                        <h4><?= number_format($quarterlyRevenue, 0, '', ',') ?> VND</h4>
                    </div>
                </div>
            </div>
            ...
            <section class="recent">
                <div class="activity-grid">
                    <div class="activity-card">
                        ...
                        <canvas id="myChartYear" style="width:100%;max-width:700px"></canvas>
                    </div>
                </div>
            </section> -->
        </main>
    ...
    <script>
        var yearlyData = {
            'Năm <?= $currentYear ?>': <?= $yearlyRevenue ?>
        };

        var barColorsYearly = getRandomColors(Object.keys(yearlyData).length);
        ...
        new Chart("myChartYear", {
            ...
            data: {
                ...
                datasets: [{
                    backgroundColor: barColorsYearly,
            ...
            options: {
                ...
                title: {
                    display: true,
                    text: "Biểu đồ doanh thu năm <?= $currentYear ?>"
                }
            }
        });
    </script>
