...
class userModel
{
    ...
    public function insert($fullName, $email, $dob, $address, $password, $provinceId, $districtId, $wardId)
    {
        ...
        $sql = "INSERT INTO users(`id`, `fullName`, `email`, `dob`, `address`, `password`, `roleId`, `status`,`captcha`, `isConfirmed`,`provinceId`,`districtId`,`wardId`) VALUES (NULL,'$fullName','$email','$dob','$address','$md5Password',2,1,'$captcha',1,$provinceId,$districtId,$wardId)";
        $result = mysqli_query($db->con, $sql);
        // if ($result) {
        ...
        //     $mail->SetFrom("khuongip564gb@gmail.com", "FRESHFOOD");
        //     $mail->Subject = "Xác nhận email tài khoản - FRESHFOOD";
        //     $mail->Body = "<h3>Cảm ơn bạn đã đăng ký tài khoản tại website FRESHFOOD</h3></br>Đây là mã xác minh tài khoản của bạn: " . $captcha . "";
