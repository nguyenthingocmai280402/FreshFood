    ...
    public function getByProductIdUserId($productId, $userId)
{
    ...
    // Sử dụng tham số truy vấn để ngăn chặn SQL injection
    $sql = "SELECT b.id, b.image, b.name, a.star, a.content 
            FROM `productrating` a 
            JOIN products b ON a.productId = b.id 
            WHERE userId=? AND productId=?";

    // Chuẩn bị truy vấn và bind tham số
